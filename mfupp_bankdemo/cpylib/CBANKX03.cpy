      ...
      *****************************************************************
      * CBANKX03.CPY (CICS Version)                                   *
      *---------------------------------------------------------------*
      * This copybook is used to provide an common means of calling   *
      * data access module DBANK03P so that the that module using     *
      ...
      * MFUPP-CID LINK2DBANK03P
           EXEC CICS LINK PROGRAM('DBANK03P')
                          COMMAREA(CD03-DATA)
                          LENGTH(LENGTH OF CD03-DATA)
           END-EXEC
      *    CALL 'DBANK03P' USING CD01-DATA
