...
for %%i in (*.cbl) do cobol %%i omf(obj) anim sourceformat"variable";
...
mkdir jbin >nul: 2>&1
for %%i in (*.cbl) do cobol %%i jvmgen(sub) anim sourceformat"variable" iloutput"jbin" ilnamespace"com.rocketsoftware.test";
